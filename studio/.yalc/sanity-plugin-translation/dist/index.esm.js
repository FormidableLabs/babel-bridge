import { useFormValue, MemberField, FormInput, useClient, defineType, defineField, definePlugin } from 'sanity';
import { jsx, jsxs } from 'react/jsx-runtime';
import { createContext, useContext, useState, useCallback, useEffect, createElement } from 'react';
import { useListeningQuery } from 'sanity-plugin-utils';
import localeEmoji from 'locale-emoji';
import { RefreshIcon, TranslateIcon, CloseCircleIcon, TransferIcon } from '@sanity/icons';
...
const usePostLocalesQuery = opts => {
  return useListeningQuery(postLocalesQuery, {
    params: {
      postId: opts.postId
    },
    initialValue: null
...
const useSupportedLanguagesQuery = () => {
  return useListeningQuery(supportedLanguagesQuery, {
    initialValue: []
  });
};
const SupportedLanguagesContext = createContext(null);
...
const SupportedLanguagesContextProvider = props => {
  ...
  return /* @__PURE__ */jsx(SupportedLanguagesContext.Provider, {
    value,
    children
  });
};
...
const TranslationServiceContext = createContext(DEFAULT_CONFIG);
...
function TranslationServiceProvider(props) {
  ...
  return /* @__PURE__ */jsx(TranslationServiceContext.Provider, {
    value: {
      ...pluginConfig
    },
    children: /* @__PURE__ */jsx(SupportedLanguagesContextProvider, {
...
const SanityDocumentInputComponent = props => {
  ...
  return /* @__PURE__ */jsx(DefaultComponentInput, {
    ...props
  });
};
const LocaleField = props => {
  ...
  return /* @__PURE__ */jsx(Stack, {
    ...
    children: supportedLanguageFields == null ? void 0 : supportedLanguageFields.map(language => {
      if (id === "localeTitle") {
        return /* @__PURE__ */createElement(MemberField, {
          ...props,
          key: language.key,
          member: language,
          renderInput: () => /* @__PURE__ */jsx(FormInput, {
            ...props,
...
const DefaultLanguage = props => {
  ...
  const isDefaultLanguage = useFormValue(["default"]);
...
var localeBlockContent = defineType({
...
var supportedLanguages = defineType({
...
export { sanityPluginTranslation };
